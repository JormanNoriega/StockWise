    ...
    <div className="App">
      ...
      <main>
        <section className="container about">
          ...
          <p className="about__paragraph">Todo lo necesario y obligatorio de CSS, (Flexbox, Grid, Custom properties,
          ...
          <div className="about__main">
            <article className="about__icons">
              ...
              <p className="about__paragrah">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae tempore
        ...
        <section className="knowledge">
          <div className="knowledge__container container">
            <div className="knowledege__texts">
              <h2 className="subtitle">Curso completo de CSS3. ¡Domina CSS de una vez por todas!</h2>
              <p className="knowledge__paragraph">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Excepturi,
              ...
              <a href="/login" className="btnComienza">Entra al curso</a>
            </div>
        ...
        <section className="questions container">
          ...
          <section className="questions__container">
            <article className="questions__padding">
              <div className="questions__answer">
                <h3 className="questions__title">¿Qué es CSS?
            ...
            <article className="questions__padding">
              <div className="questions__answer">
                <h3 className="questions__title">¿Qué aprenderé en este curso?
                  <span className="questions__arrow">
                    <img src="./public/images/arrow.svg" alt="arrow" className="questions__img" />
                  </span>
                </h3>
            ...
            <article className="questions__padding">
              <div className="questions__answer">
                <h3 className="questions__title">¿Qué es CSS GRID?
                  <span className="questions__arrow">
                    <img src="./public/images/arrow.svg" alt="arrow" className="questions__img" />
                  </span>
                </h3>
          ...
          <section className="questions__offer">
            ...
            <a href="/registro" className="btnComienza">Aprende ahora</a>
          </section>
        </section>
      </main>
      ...
      <footer className="footer">
        ...
        <section className="footer__copy container">
          <div className="footer__social">
            <a href="#" className="footer__icons"><img src="./public/images/facebook.svg" alt="facebook" className="footer__img" /></a>
            <a href="#" className="footer__icons"><img src="./public/images/twitter.svg" alt="twitter" className="footer__img" /></a>
            <a href="#" className="footer__icons"><img src="./public/images/youtube.svg" alt="youtube" className="footer__img" /></a>
          </div>

          <h3 className="footer__copyright">Derechos reservados &copy; StockWise</h3>
        </section>
      </footer>
